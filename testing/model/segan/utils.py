...
def PESQ(ref_wav, deg_wav):
    ...
    # ref_tfl = './noisy_testset/' + '_ref.wav'
    # deg_tfl = './results/' + '_deg.wav'
    #
    #
    ...
    score = pesq(ref=ref_wav, deg=deg_wav, fs=16000, mode='wb')
    # print(score)
    return score

def PESQ_previous(ref_wav, deg_wav):
    # reference wav
    # degraded wav
    # print('6: ', type(ref_wav))
    # print('7: ', type(deg_wav))
    ...
    curr_dir = os.getcwd()
    # print('10: ', type(curr_dir))
    # print('10: ', curr_dir)
    # print('10: ', '{}/pesqmain'.format(curr_dir))
